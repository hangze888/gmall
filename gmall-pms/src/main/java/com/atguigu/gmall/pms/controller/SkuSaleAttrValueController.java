...
public class SkuSaleAttrValueController {
    ...
    public Resp<List<SkuSaleAttrValueEntity>> querySaleAttrValueBySpuId(@PathVariable("spuId")Long spuId){
        List<SkuSaleAttrValueEntity> saleAttrValueEntities = skuSaleAttrValueService.querySaleAttrValueBySpuId(spuId);
    ...
    public Resp<List<SkuSaleAttrValueEntity>> querySaleAttrValueSkuId(@PathVariable("skuId") Long skuId){
        List<SkuSaleAttrValueEntity> attrValueEntities = skuSaleAttrValueService.list(new QueryWrapper<SkuSaleAttrValueEntity>().eq("sku_id", skuId));
